...
public class Ranking {
    ...
    @Column(name = "rank_position", nullable = false) private Integer rankPosition;
    @Column(name = "is_promoted", nullable = false) private Boolean isPromoted = false;
    @ManyToOne(fetch = FetchType.LAZY) @JoinColumn(name = "computed_by")
    private User computedBy;
    @CreationTimestamp @Column(name = "computed_at", updatable = false)
    private LocalDateTime computedAt;
    @Column(name = "snapshot_note") private String snapshotNote;
}
